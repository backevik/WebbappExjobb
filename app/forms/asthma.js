...
var myApp = angular.module('myApp.asthma', ['ngRoute', 'chart.js']);
...
myApp.controller('AsthmaCtrl', function($scope, $location, $http, $filter) {
  ...
  .success(function (data) {
                ...
                angular.forEach($scope.listOfDevices, function(value, index){
                  $http.get('http://46.101.96.201:8080/api/forms/asthma/'+value.crypt, config)
                  .success(function (data) {
